...
GPU="${GPU:-2}"
SESSION="${SESSION:-groot_n17_decoder_action_token_medoid_pairs_gpu2}"
...
for label in seeds_2_997_996 seeds_3_995_994; do
...
server_a=\$(start_server 2,997,996 5582 "${OUT_ROOT}/seeds_2_997_996")
server_b=\$(start_server 3,995,994 5583 "${OUT_ROOT}/seeds_3_995_994")
wait_ready() {
...
wait_ready "\${server_a}" 'seeds=(2, 997, 996)' "${OUT_ROOT}/seeds_2_997_996/logs/server_gpu${GPU}.log"
wait_ready "\${server_b}" 'seeds=(3, 995, 994)' "${OUT_ROOT}/seeds_3_995_994/logs/server_gpu${GPU}.log"
run_eval() {
...
run_eval "${OUT_ROOT}/seeds_2_997_996" 5582 2,997,996 &
eval_a=\$!
run_eval "${OUT_ROOT}/seeds_3_995_994" 5583 3,995,994 &
eval_b=\$!
wait "\${eval_a}"
wait "\${eval_b}"
EOF
